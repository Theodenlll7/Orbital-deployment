...
static func set_data() -> void:
	...
	data =  {
		1: "Use [color=green]" + move_up_key + "[/color], [color=green]" + move_left_key + "[/color], [color=green]" + move_down_key + "[/color] and [color=green]" + move_right_key + "[/color] to move around.",
